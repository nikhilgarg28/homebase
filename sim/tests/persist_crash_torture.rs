...
//!
//! Same harness as Layer 1 ([`homebase_sim::crash`]) but crash = object-store
...
//!
//! Run: `cargo test -p homebase-sim persist_crash`
//! Skip: `cargo test -p homebase-sim --no-default-features` (slate tests omitted)

#![cfg(feature = "slatedb")]

use homebase_sim::crash::slate;
