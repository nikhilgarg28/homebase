...
multilite
- Extend debug/CI branch-versus-canonical differential verification from row
  after-images and retired row identities to physical schema structure for
  CREATE/ALTER/INDEX operations. Introspect and compare normalized SQLite
  schema objects by stable Multilite identity; do not compare stored SQL text.
