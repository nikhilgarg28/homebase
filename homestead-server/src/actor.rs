...
//! [`Space` trait](homestead_core::space::Space).
//!
...
//! floods directly.
//!
//! [`ManualClock`]: homestead_core::clock::ManualClock
...
use homestead_core::space::{Space as SpaceApi, SpaceError, SpaceId};
use std::pin::Pin;
use std::sync::Arc;
...
mod tests {
    ...
    use homestead_core::messages::{KernelError, LeaseSpec, PutEntry};
